...
class ProvisionStandardAccountTemplatesAction
{
    ...
    private function definitions(): array
    {
        ...
        return [
            ...
            $row('1112', 'Site Petty Cash', $a, '1110', AccountingMappingKey::SitePettyCash, false, true),
            $row('1113', 'Director Cash / Advance', $a, '1110', AccountingMappingKey::DirectorCashAdvance, false, true),
            ...
            $row('2145', 'Staff Reimbursement Payable', $l, '2100', AccountingMappingKey::StaffReimbursementPayable, false, true),
            ...
            $row('2180', 'Rent Payable', $l, '2100', AccountingMappingKey::RentalPayable, false, true),
            ...
            ...array_map(fn (array $v) => $row($v[0], $v[1], $l, '2200', $v[2] ?? null, false, true), [
                ['2210', 'Bank Loan'],
                ['2220', 'Director Loan', AccountingMappingKey::DirectorLoan],
                ['2230', 'Partner Loan'],
                ['2240', 'Vehicle Loan'],
            ]),
            ...
            $row('5000', 'Expenses', $x),
            ...array_map(fn (array $v) => $row($v[0], $v[1], $x, '5000', null, false, true, $v[2] ?? null), [
                ['5050', 'Bidding & Tender Expenses', [$c]],
                ['5051', 'Tender Fee', [$c]],
                ['5052', 'Tender Documentation', [$c]],
                ['5053', 'Bid Preparation', [$c]],
                ['5054', 'Site Visit (Bidding)', [$c]],
                ['5055', 'Bid Bond Bank Charges', [$c]],
                ['5056', 'E-Procurement Registration Fee', [$c]],
                ['5057', 'Bidding Consultancy Charges', [$c]],
                ['5058', 'Miscellaneous Bidding Expenses', [$c]],
                ['5100', 'Salaries'],
                ['5150', 'Staff Engagement / Office Events'],
                ['5200', 'Fuel'],
                ['5300', 'Office Rent'],
                ['5400', 'Utilities'],
                ['5450', 'Cleaning Expense'],
                ['5500', 'Internet'],
                ['5550', 'Mobile & Telephone Expense'],
                ['5600', 'Vehicle Rent'],
                ['5700', 'Printing'],
                ['5800', 'Stationery'],
                ['5900', 'Repairs & Maintenance'],
                ['6000', 'Vehicle Maintenance'],
                ['6100', 'Depreciation'],
                ['6200', 'Marketing'],
                ['6210', 'Domain & Hosting Expense'],
                ['6220', 'Corporate Branding Expense'],
                ['6230', 'Project Marketing Expense'],
                ['6240', 'Recruitment Advertising Expense'],
                ['6250', 'Digital Marketing / Ad Spend'],
                ['6300', 'Legal & Professional'],
                ['6400', 'Audit'],
                ['6500', 'Consultancy'],
                ['6600', 'Software Subscription'],
                ['6700', 'Entertainment'],
                ['6800', 'Travelling & Conveyance'],
                ['6850', 'Hotel & Accommodation Expense'],
                ['6900', 'Miscellaneous'],
            ]),
            ...
            ...array_map(fn (array $v) => $row($v[0], $v[1], $x, '7000', null, false, true, [$c]), [
                ...
                ['7290', 'Site Misc Expense'],
                ['7295', 'Site Legal & Surveyor Expense'],
            ]),
