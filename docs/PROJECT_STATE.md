...
- **General & Group Expenses (Phase I)**: Single-screen fast operational and overhead recording locked to Corporate Master Book (`7 Orbit Corporate`), supporting staff tea/kitchen, shared utilities, internet, stationery, and shared fixed assets with automatic GL voucher generation.
